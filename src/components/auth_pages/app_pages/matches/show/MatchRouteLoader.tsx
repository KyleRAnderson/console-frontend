...
import { matchesPath, MATCH_NUMBER_PARAM } from '../../../../../routes/AppPaths';
...
export default function MatchRouteLoader({ onLoaded, hunt, children, isLoaded, onReload }: Props): JSX.Element {
    const { [MATCH_NUMBER_PARAM]: matchNumber } = useParams<{ [MATCH_NUMBER_PARAM]?: string }>();
